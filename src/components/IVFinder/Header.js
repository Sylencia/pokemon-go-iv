  ...
  render() {
    ...
    const instructions = this.state.showFaq ? (
      <div className="new-section">
        ...
        we only consider odd numbered levels for your pokémon.
        ...
        few times to get the exact number.
        <h5><u>what is 'iv %'?</u></h5>
        the iv % shows you how close to maximum that iv set is. this is achieved by dividing the sum
        of the three ivs by the maximum sum, which is 45.
